...
var giftList = [{
    ...
    name: 'Wieco Art 5 Panels Abstract Paintings',
    price: 45,
    categories: ['home'],
    ...
    name: 'Trimmer Polyresin Toilet Seat',
    price: 35,
    categories: ['home'],
    recipientType: ['family'],
    ...
    name: 'YardStash Outdoor Bike Storage',
    price: 150,
    categories: ['sports'],
    recipientType: ['friend', 'SO'],
    ...
    description: 'Kids will have ball with the BBOP. To play, roll it around or climb inside and wear it. Offers endless hours of energetic play. Sold individually. Fits kids ages 6 and up.',
    tags: {
      gender: ['men', 'women'],
      ageMin: 0,
      ageMax: 21,
